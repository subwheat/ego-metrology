...
|-----------|------|-----------|--------------|-----------|-------------|--------------|
| `single_pass` ✓ | 4 | 0.50 | 1.25 | 168.25 | 0.00 | 1.00 |

## Recommendation

**Default policy : `single_pass`**

Highest quality pass rate with best overall tradeoff (pass rate 50%, mean regret 0.0, mean cost 168.2).
